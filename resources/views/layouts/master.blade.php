...
<body class="bg-gray-100 font-family-karla flex">
    ...
    <aside class="relative bg-sidebar h-screen w-64 hidden sm:block shadow-xl">
        ...
        <nav class="text-white text-base font-semibold pt-3">
            <a href="/dashboard" class="flex items-center text-white {{ (request()->is('dashboard')) ? 'active-nav-link' : '' }} opacity-75 hover:opacity-100 py-4 pl-6 nav-item">
                <i class="fas fa-tachometer-alt mr-3"></i>
                Dashboard
            </a> 
            <a href="/contact" class="flex items-center   {{ (request()->is('contact')) ? 'active-nav-link' : '' }} text-white py-4 pl-6 nav-item">
    ...
    @livewireScripts
     ...
     <script src="/js/attachments.js" defer></script>
